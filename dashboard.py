...
from School_s import School
from Student_s import Student
...
class IMS:
    def __init__(self, window):
        ...
        school_diaries_label = tk.Label(school_diaries_rectangle, text="MY FIRST SCRIBBLE", fg="white", bg="#2F4D99",
